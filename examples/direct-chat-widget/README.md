...
The compact open-panel header uses a thin theme-colored outline and a pulsing dot beside its title.
Reduced-motion preferences disable the pulse automatically.
