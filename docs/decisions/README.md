...
Accepted decisions define the current architecture. When the context changes, add a new ADR and
mark the old one as superseded. Do not rewrite decision history.

- [ADR-001: Run the core as a standalone service](001-standalone-service.md)
